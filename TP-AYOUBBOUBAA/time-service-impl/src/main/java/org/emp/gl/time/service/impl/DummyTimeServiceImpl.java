...
public class DummyTimeServiceImpl implements TimerService {
    ...
    public void setHeures(int newValue) {
        if (this.heures != newValue) {
            int old = this.heures;
            this.heures = newValue;
